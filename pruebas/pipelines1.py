...
if False:
    ...
    pipeline = make_pipeline(vectorizer, tfidf, MultinomialNB(alpha=0.01))
    ...
    print m
    saveConfusionMatrix(m, '../../Data/m_m-1.m')
...
if False:
    ...
    m = confusion_matrix(y_test, y_predicted)
    print m
    saveConfusionMatrix(m, '../../Data/m_m-2.m')    
...
if False:
    ...
    m = confusion_matrix(y_test, y_predicted)
    print m
    saveConfusionMatrix(m, '../../Data/m_m-3.m')
...
if False:
    ...
    kmeans = KMeans(n_clusters=3, random_state=0, verbose=1, max_iter=4).fit(data_5)
    for idx, c in enumerate(kmeans.labels_):
        resto.append(cincos[idx])
        resto_t.append('5' + str(c))
    data = resto
    ...
    m = confusion_matrix(y_test, y_predicted)
    print m
    saveConfusionMatrix(m, '../../Data/m_m-4.m')    
...
if True:
    ...
    m = confusion_matrix(y_test, y_predicted)
    print m
    saveConfusionMatrix(m, '../../Data/m_m-5.m')       
